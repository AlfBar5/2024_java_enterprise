...
<script type="text/javascript">
	...
	//TemaDto en un objeto, que tiene la propiedad tema
	function gestionarPeticion(url,params){
		$.get(url,params,function(data){
			var tabla="<br><br><table class='table table-striped table-sm' ><tr><th>ISBN</th><th>TÍTULO</th><th>AUTOR</th><th>PRECIO</th><th>PÁGINAS</th><th>TEMA</th><th></th></tr>";
			$.each(data,function(i,p){
				tabla+="<tr><td>"+p.isbn+"</td><td>"+p.titulo+"</td><td>"+p.autor+"</td><td>"+p.precio+"</td><td>"+p.paginas+"</td><td>"+p.temaDto.tema+"</td><td><a href='#' onclick='agregarCarrito("+p.isbn+")'>Agregar</a></td></tr>";
			});
			tabla+="</table>";
			$("#tbLibros").html(tabla);
		});
	...
	//Esto lo ponemos en una función aparte para ahorrar código. TemaDto en un objeto, que tiene la propiedad tema
	function pintarCarrito(params){
		...
		$.get(url,params,function(data){
			var tabla="<br><br><table class='table table-striped table-sm'><tr><th>ISBN</th><th>TÍTULO</th><th>AUTOR</th><th>PRECIO</th><th>PÁGINAS</th><th>TEMA</th><th></th></tr>";
			$.each(data,function(i,p){
			tabla+="<tr><td>"+p.isbn+"</td><td>"+p.titulo+"</td><td>"+p.autor+"</td><td>"+p.precio+"</td><td>"+p.paginas+"</td><td>"+p.temaDto.tema+"</td><td><a href='#' onclick='quitarCarrito("+i+")'>Quitar</a></td></tr>";
		});
		tabla+="</table>";
